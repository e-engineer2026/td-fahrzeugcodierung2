    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="card mt-6 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700">
          ...
          <p className="mt-2">Timo Drechsler · TD Fahrzeugcodierung<br/>Schenkendorfstraße 33, 04275 Leipzig, Deutschland<br/>E-Mail: info@td-fahrzeugcodierung.com<br/>Telefon: 01556 3047044</p></section>
