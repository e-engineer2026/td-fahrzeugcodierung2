    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="card mt-6 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700">
          ...
          <section><h2 className="text-xl font-bold text-slate-900">4. Kontaktaufnahme</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">5. WhatsApp</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">6. Terminbuchung über Cal.com</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">7. Lokaler Buchungsspeicher im Browser</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">8. Zahlung über PayPal</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">9. Remote-Zugriff</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">10. Speicherdauer</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">11. Ihre Rechte</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">12. Stand</h2><p className="mt-2">Stand: August 2026.</p></section>
