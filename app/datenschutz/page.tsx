    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="card mt-6 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700">
          ...
          <section><h2 className="text-xl font-bold text-slate-900">5. Google Analytics 4</h2>
          <p className="mt-2">Google Analytics 4 wird nur geladen, wenn Sie im Analyse-Hinweis ausdrücklich zustimmen. Ohne diese Zustimmung wird der Google-Analytics-Tag nicht geladen. Bei aktivierter Analyse werden Seitenaufrufe und ausgewählte Interaktionen wie Termin-, WhatsApp-, Telefon-, E-Mail-, Kontakt- und PayPal-Klicks erfasst. Inhalte aus Formularfeldern, FIN oder andere frei eingegebene Fahrzeug- und Kontaktdaten werden nicht als Analyseereignisse an Google Analytics übermittelt. Die Einwilligungsentscheidung wird lokal im Browser gespeichert und kann über „Analyse-Einstellungen“ jederzeit geändert werden.</p>
          <p className="mt-2">Anbieter ist Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland. Für die Verarbeitung durch Google gelten ergänzend die Datenschutzinformationen und Nutzungsbedingungen von Google.</p></section>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">7. WhatsApp</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">8. Terminbuchung über Cal.com</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">9. Lokaler Buchungsspeicher im Browser</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">10. Zahlung über PayPal</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">11. Remote-Zugriff</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">12. Speicherdauer</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">13. Ihre Rechte</h2>
          ...
          <section><h2 className="text-xl font-bold text-slate-900">14. Stand</h2><p className="mt-2">Stand: August 2026.</p></section>
