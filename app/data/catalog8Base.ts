...
const tCrossCodings: Coding[] = [
  ...
  { id:"tcross-acc-res", name:"ACC: RES-Taste zur Beschleunigung nutzen", price:25, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Werkseitiges bzw. vollständig nachgerüstetes, kompatibles ACC-System muss vorhanden und fehlerfrei sein; Verfügbarkeit der Anpassung abhängig von Steuergerät und Softwarestand.", sourceUrl:tCrossSource },
  ...
  { id:"tcross-lane-memory", name:"Lane Assist – letzte Einstellung speichern", price:29, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Lane Assist mit kompatibler Frontkamera muss bereits vorhanden und funktionsfähig sein; Anpassung abhängig von Kamera-/Softwarestand.", sourceUrl:tCrossSource },
  ...
  { id:"tcross-rvc", name:"Rückfahrkamera nach Nachrüstung aktivieren", price:49, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Kompatible Rückfahrkamera, vollständige Verkabelung und kompatibles Infotainment erforderlich; je nach Kameratyp zusätzlich Parametrierung und/oder Kalibrierung notwendig.", sourceUrl:tCrossSource },
  ...
  { id:"tcross-lane-activate", name:"Lane Assist / Spurhalteassistent aktivieren", price:49, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Kompatible Frontkamera, passende Lenkungs-/Assistenzhardware und vollständige Einbindung erforderlich; nach Kameranachrüstung bzw. -tausch ist eine Kalibrierung erforderlich. Machbarkeit abhängig von Steuergeräte- und Softwarestand.", sourceUrl:tCrossSource },
  { id:"tcross-lane-settings", name:"Lane Assist – Warnung, Lenkeingriff und Vibration anpassen", price:29, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Lane Assist muss bereits vorhanden und funktionsfähig sein; verfügbare Warn-, Lenk- und Vibrationsparameter sind vom Kamera-/Softwarestand abhängig.", sourceUrl:tCrossSource },
  ...
  { id:"tcross-fla", name:"Fernlichtassistent / Light Assist aktivieren", price:59, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Kompatible Frontkamera und Lichtsteuerung/Scheinwerferkonfiguration erforderlich; Aktivierung abhängig von Kamera-, BCM-/Lichtsteuerungs- und Softwarestand.", sourceUrl:tCrossSource },
  { id:"tcross-fla-memory", name:"Light Assist – letzte Einstellung speichern", price:29, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Light Assist / Fernlichtassistent muss bereits vorhanden und funktionsfähig sein; Speicherfunktion abhängig von Steuergeräte- und Softwarestand.", sourceUrl:tCrossSource },
  ...
  { id:"tcross-acc-1kmh", name:"ACC Bedienung in 1-km/h-Schritten anpassen", price:25, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Kompatibles ACC-System muss vorhanden und funktionsfähig sein; 1-km/h-Bedienlogik abhängig von Lenkrad-/ACC-Steuergerät und Softwarestand.", sourceUrl:tCrossSource },
  { id:"tcross-vze", name:"Verkehrszeichenerkennung / Sign Assist aktivieren", price:59, category:"Assistenzsysteme", uiGroup:"Assistenz", interfaceInfo:"VCDS / OBD11", hardware:"Kompatible Frontkamera sowie unterstütztes Kombiinstrument/Infotainment erforderlich; Kamera muss korrekt eingebunden und kalibriert sein. Verfügbarkeit abhängig von Kamera-, Navigations-/Infotainment- und Softwarestand.", sourceUrl:tCrossSource },
