...
export default function Page() {
  return <SeoServicePage
    ...
    details={[
      "Bei Audi reichen die möglichen Anpassungen von Komfort- und Lichtfunktionen über Kombiinstrument und Infotainment bis zu Assistenzsystemen. Häufig angefragt werden unter anderem Spiegel- und Fensterfunktionen, Coming Home/Leaving Home, Lichtanpassungen, Kombiinstrument-Funktionen sowie die Aktivierung bereits hardwareseitig vorhandener Assistenzfunktionen.",
      ...
      "Nachrüstungen oder Steuergerätetausch können zusätzliche Arbeiten erforderlich machen, zum Beispiel Codierung, Anpassungen, Grundeinstellungen oder Parametrierung. Ob diese Schritte mit VCDS, VCP oder ODIS sinnvoll und zulässig umsetzbar sind, wird vor der Durchführung eingeordnet.",
    ...
    relatedLinks={[
      ...
      { href: "/fahrzeuge/audi/a6-s6-c7-codierung", label: "Audi A6 / S6 C7", description: "Typische Komfort-, Licht-, Infotainment- und Diagnoseleistungen für A6 / S6 C7." },
      ...
      { href: "/steuergeraete-diagnose-leipzig", label: "Audi Steuergeräte-Diagnose", description: "Fehlerspeicher, Steuergeräte, Softwarestände und technische Voraussetzungen prüfen lassen." },
