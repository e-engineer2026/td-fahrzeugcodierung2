...
export const priorityVehicleSeoByPath: Record<string, PriorityVehicleSeo> = {
  ...
  "vw/t-roc-a11-codierung": {
    label: "VW T-Roc (A11)",
    title: "VW T-Roc Codierung Leipzig | VCDS, VCP & Diagnose | TD",
    description: "VW T-Roc Codierung in Leipzig oder Remote: Komfort, Licht, Anzeige, Assistenzsysteme und Diagnose. Ausstattung und Machbarkeit vorab prüfen.",
    intro: "Beim VW T-Roc (A11) sind je nach Modelljahr und Ausstattung zahlreiche Komfort-, Licht-, Anzeige- und Assistenzanpassungen möglich. Vor der Durchführung werden Steuergeräte, Softwarestand und vorhandene Hardware geprüft.",
    focus: ["Komfort- und Verriegelungsfunktionen", "Tagfahrlicht, Coming Home / Leaving Home und weitere Lichtoptionen", "Anzeige- und Infotainmentanpassungen", "Assistenzsysteme nur bei geeigneter Kamera- und Sensorhardware"],
  },
  "vw/t-cross-c1-codierung": {
    label: "VW T-Cross (C1)",
    title: "VW T-Cross Codierung Leipzig | VCDS, Assistenz & Diagnose | TD",
    description: "VW T-Cross Codierung in Leipzig oder Remote: Komfort, Licht, Virtual Cockpit, Assistenzsysteme und Diagnose. Funktionen und Preise vorab prüfen.",
    intro: "Beim VW T-Cross (C1) können abhängig von Ausstattung und Softwarestand unter anderem Komfort-, Licht-, Infotainment- und Assistenzfunktionen angepasst werden. Die konkrete Fahrzeugkonfiguration wird vor jeder Änderung geprüft.",
    focus: ["Virtual Cockpit, Anzeige- und Infotainmentanpassungen", "Tagfahrlicht, Heckleuchten und Lichtfunktionen", "Spiegel-, Fenster- und KESSY-Komfortfunktionen", "Lane Assist, Light Assist und VZE nur bei geeigneter Hardware"],
  },
  "vw/taigo-cs-codierung": {
    label: "VW Taigo (CS)",
    title: "VW Taigo Codierung Leipzig | VCDS, Komfort & Diagnose | TD",
    description: "VW Taigo Codierung in Leipzig oder Remote: Komfort, Licht, Anzeige, Assistenzsysteme und Diagnose. Fahrzeugbezogene Machbarkeit vorab prüfen.",
    intro: "Beim VW Taigo (CS) hängt die Verfügbarkeit einzelner Anpassungen von Modelljahr, Ausstattung, Softwarestand und den tatsächlich verbauten Steuergeräten ab. Deshalb wird jede gewünschte Funktion vorab geprüft.",
    focus: ["Komfort- und Verriegelungsfunktionen", "Licht- und Tagfahrlicht-Anpassungen", "Anzeige- und Infotainmentfunktionen", "Assistenzfunktionen nur bei kompatibler Serienhardware"],
  },
  "vw/caddy-iii-iv-2k-sa-codierung": {
    label: "VW Caddy III / IV (2K / SA)",
    title: "VW Caddy 2K / SA Codierung Leipzig | VCDS & Diagnose | TD",
    description: "VW Caddy 2K und SA Codierung in Leipzig oder Remote: Licht, Komfort, Zeigertest, Regenschließen und Diagnose. Technische Voraussetzungen prüfen.",
    intro: "Beim VW Caddy III / IV (2K / SA) lassen sich je nach Bordnetz-, Komfort- und Kombiinstrument-Version verschiedene Licht- und Komfortfunktionen anpassen. Die vorhandenen Steuergeräte werden vorab geprüft.",
    focus: ["Auto-Lock / Auto-Unlock und Komfortfunktionen", "Coming Home / Leaving Home und Tagfahrlicht", "Zeigertest und Kombiinstrumentfunktionen", "Regenschließen, Wischer- und Lichtanpassungen"],
  },
  "vw/caddy-v-sb-codierung": {
    label: "VW Caddy V (SB)",
    title: "VW Caddy V (SB) Codierung Leipzig | SFD1 & Diagnose | TD",
    description: "VW Caddy V Codierung in Leipzig: SFD1-relevante Komfort- und Lichtanpassungen sowie Diagnose. Steuergerät und Softwarestand vorab prüfen.",
    intro: "Der VW Caddy V (SB) nutzt die MQB-evo-Elektronikarchitektur. Deshalb werden SFD-Relevanz, Softwarestand und die verfügbaren Anpassungskanäle vor jeder Codierung gezielt geprüft.",
    focus: ["SFD1-relevante Anpassungen, soweit unterstützt", "Auto-Lock / Auto-Unlock und Komfortfunktionen", "Tagfahrlicht und Coming Home / Leaving Home", "Diagnose und Prüfung der Steuergeräte-Konfiguration"],
  },
  "vw/passat-b9-codierung": {
    label: "VW Passat B9",
    title: "VW Passat B9 Codierung Leipzig | SFD1, VAG Diagnose | TD",
    description: "VW Passat B9 Codierung in Leipzig: SFD1-relevante Anpassungen, Komfort, Assistenzsysteme und Diagnose. Machbarkeit fahrzeugbezogen prüfen.",
    intro: "Beim VW Passat B9 sind Softwarestand, SFD-Relevanz und die verbaute Assistenzhardware entscheidend. Anpassungen werden deshalb vor der Durchführung fahrzeugbezogen geprüft.",
    focus: ["SFD1-relevante Anpassungen, soweit technisch unterstützt", "Komfort- und Anzeigeanpassungen", "Assistenzsysteme bei vorhandener kompatibler Hardware", "Diagnose und Prüfung moderner MQB-evo-Steuergeräte"],
  },
  "skoda/superb-3v-codierung": {
    label: "Škoda Superb 3V",
    title: "Škoda Superb 3V Codierung Leipzig | VCDS, VCP & Diagnose | TD",
    description: "Škoda Superb 3V Codierung in Leipzig oder Remote: Komfort, Licht, Assistenzsysteme und Diagnose. Funktionen und Voraussetzungen vorab prüfen.",
    intro: "Beim Škoda Superb 3V sind je nach Ausstattung zahlreiche Komfort-, Licht- und Assistenzanpassungen möglich. Steuergeräte, Kamera- und Sensorhardware sowie Softwarestand werden vorab geprüft.",
    focus: ["Spiegel-, Fenster- und Verriegelungskomfort", "Coming Home / Leaving Home und Lichtfunktionen", "Anzeige- und Infotainmentanpassungen", "VZE, Lane Assist und weitere Assistenzfunktionen nur bei geeigneter Hardware"],
  },
  "seat-cupra/cupra-formentor-km-codierung": {
    label: "CUPRA Formentor (KM)",
    title: "CUPRA Formentor Codierung Leipzig | SFD1 & Diagnose | TD",
    description: "CUPRA Formentor Codierung in Leipzig: SFD1-relevante Anpassungen, Komfort, Anzeige, Assistenzsysteme und Diagnose. Machbarkeit vorab prüfen.",
    intro: "Beim CUPRA Formentor (KM) spielen SFD, Softwarestand und die tatsächlich verbaute Assistenz- und Komforthardware eine wichtige Rolle. Deshalb erfolgt vor jeder Änderung eine fahrzeugbezogene technische Prüfung.",
    focus: ["SFD1-relevante Anpassungen, soweit unterstützt", "Komfort- und Anzeigeanpassungen", "Licht- und Infotainmentfunktionen", "Assistenzsysteme nur bei vorhandener kompatibler Hardware"],
  },
};
