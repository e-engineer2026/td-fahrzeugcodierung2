    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="card mt-6 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700">
          ...
          <p className="mt-2">Es gelten die bei der Buchung angezeigten beziehungsweise individuell vereinbarten Preise. TD Fahrzeugcodierung ist Kleinunternehmer gemäß § 19 UStG; Umsatzsteuer wird nicht gesondert ausgewiesen. Bei Remote-Aufträgen sind grundsätzlich 70 % des vereinbarten Gesamtpreises vor dem Termin und 30 % nach Durchführung fällig, sofern nichts anderes vereinbart wurde. Die Website stellt hierfür getrennte PayPal-Zahlungslinks bereit. Vor-Ort-Leistungen können entsprechend der Buchung bar, per PayPal oder per Sofortüberweisung bezahlt werden.</p></section>
