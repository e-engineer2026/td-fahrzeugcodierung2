...
export default function Home(){
 return <main className="pb-20 md:pb-0">
  <header className="sticky top-0 z-50 border-b border-blue-100 bg-white/95 backdrop-blur">
    <div className="container-x flex h-14 items-center justify-end gap-3 sm:h-16">
      ...
      <div className="flex shrink-0 items-center gap-2 sm:gap-3">
        ...
        <a href="#kontakt" className="hidden items-center justify-center rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-blue-700 sm:inline-flex">Direkt anfragen</a>
      </div>
    </div>
  </header>
  ...
  <section className="hero-grid border-b border-blue-100 bg-white">
    <div className="container-x grid items-center gap-8 py-12 sm:gap-10 sm:py-16 lg:min-h-[650px] lg:grid-cols-[1.15fr_.85fr] lg:gap-12 lg:py-20">
      <div>
        ...
        <div className="mt-5 flex max-w-[620px] items-center gap-4 sm:mt-6 sm:gap-6">
          <img src="/td-logo-icon.png" alt="TD Fahrzeugcodierung" className="h-20 w-auto sm:h-28" />
        ...
        <div className="mt-6 max-w-xl rounded-2xl border border-blue-200 bg-blue-50 p-4 sm:mt-7 sm:p-5"><b className="text-blue-900">Staffelrabatt automatisch:</b><div className="mt-3 grid grid-cols-2 gap-2 text-sm text-blue-800 sm:flex sm:flex-wrap sm:gap-x-4"><span>ab 50 €: <b>5 %</b></span><span>ab 100 €: <b>10 %</b></span><span>ab 150 €: <b>15 %</b></span><span>ab 200 €: <b>20 %</b></span></div></div>
        <div className="mt-7 flex flex-col gap-3 sm:mt-8 sm:flex-row"><a href="#buchen" className="btn-primary w-full sm:w-auto">Codierungen auswählen</a><a href="#kontakt" className="btn-secondary w-full sm:w-auto"><MessageCircle className="mr-2 h-4 w-4"/>Machbarkeit anfragen</a></div>
      </div>
      <div className="card p-5 sm:p-8"><img src="/td-logo-icon.png" alt="" className="h-16 w-auto sm:h-20"/><h2 className="mt-5 text-2xl font-black sm:mt-7 sm:text-3xl">Persönlich oder per Remote</h2><div className="mt-5 grid gap-3 sm:mt-6 sm:grid-cols-2 lg:grid-cols-1 lg:gap-4"><div className="rounded-2xl bg-blue-50 p-4 sm:p-5"><MapPin className="h-6 w-6 text-blue-600"/><b className="mt-3 block">Leipzig-Süd</b><span className="mt-1 block text-sm leading-6 text-slate-600">Schenkendorfstraße 33, 04275 Leipzig</span></div><div className="rounded-2xl border border-blue-300 bg-blue-50 p-4 sm:p-5"><Laptop className="h-6 w-6 text-blue-600"/><b className="mt-3 block">Remote</b><span className="mt-1 block text-sm leading-6 text-slate-600">Mit eigenem Diagnoseinterface, PC/Laptop, stabiler Internetverbindung und AnyDesk.</span></div></div></div>
    </div>
  </section>
  ...
  <section id="kontakt" className="scroll-mt-20 border-y border-blue-100 bg-white"><div className="container-x py-14 sm:py-20"><div className="max-w-3xl"><div className="text-xs font-bold uppercase tracking-[.16em] text-blue-600 sm:text-sm sm:tracking-[.18em]">Kontakt & Vorprüfung</div><h2 className="mt-3 text-3xl font-black leading-tight sm:text-4xl">Unsicher, ob deine Codierung möglich ist?</h2><p className="mt-4 leading-7 text-slate-600">Sende Fahrzeug, Baujahr und gewünschte Funktion zur Vorprüfung – direkt per WhatsApp oder über das Kontaktformular.</p></div><div className="mt-8 sm:mt-10"><ContactBox /></div></div></section>
  <section id="faq" className="scroll-mt-20 border-t border-blue-100 bg-white"><div className="container-x py-14 sm:py-20 lg:py-24"><h2 className="text-3xl font-black sm:text-4xl">FAQ</h2><div className="mt-6 space-y-3 sm:mt-8"><details className="card p-5 sm:p-6"><summary className="cursor-pointer font-bold">Was brauche ich für Remote?</summary><p className="mt-4 text-sm leading-6 text-slate-600 sm:text-base">Ein eigenes kompatibles Diagnoseinterface (z. B. VCDS, VCP oder OBD11), Windows-PC/Laptop, stabile Internetverbindung und AnyDesk.</p></details><details className="card p-5 sm:p-6"><summary className="cursor-pointer font-bold">Sind alle Funktionen garantiert möglich?</summary><p className="mt-4 text-sm leading-6 text-slate-600 sm:text-base">Nein. Die Machbarkeit hängt von Hardware, Steuergeräten, Softwarestand und Fahrzeugkonfiguration ab und wird vor Durchführung geprüft.</p></details><details className="card p-5 sm:p-6"><summary className="cursor-pointer font-bold">Wie bezahle ich?</summary><p className="mt-4 text-sm leading-6 text-slate-600 sm:text-base">Vor Ort bar oder per PayPal. Remote per PayPal: 70 % vor Beginn und 30 % nach Durchführung der vereinbarten Codierung.</p></details></div></div></section>
  ...
  <div className="fixed inset-x-0 bottom-0 z-50 border-t border-blue-100 bg-white/95 p-3 shadow-[0_-8px_30px_rgba(15,23,42,.08)] backdrop-blur md:hidden"><div className="mx-auto flex max-w-md gap-2"><a href="#buchen" className="btn-primary flex-1 px-3 py-3 text-sm">Termin buchen</a><a href="#kontakt" className="btn-secondary flex-1 px-3 py-3 text-sm">Anfragen</a></div></div>
 </main>
}
