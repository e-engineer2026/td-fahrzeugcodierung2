    ...
    <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="card mt-6 p-6 sm:p-10">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-slate-700">
          ...
          <p className="mt-2">Um Ihr Widerrufsrecht auszuüben, müssen Sie uns – Timo Drechsler, TD Fahrzeugcodierung, Schenkendorfstraße 33, 04275 Leipzig, Telefon: 01556 3047044, E-Mail: td.codierung@gmail.com – mittels einer eindeutigen Erklärung, zum Beispiel per Brief oder E-Mail, über Ihren Entschluss informieren. Sie können dafür das unten aufgeführte Muster-Widerrufsformular verwenden; dessen Verwendung ist nicht vorgeschrieben.</p>
          ...
          <div className="mt-4 space-y-2">
            <p>An: Timo Drechsler, TD Fahrzeugcodierung, Schenkendorfstraße 33, 04275 Leipzig, E-Mail: td.codierung@gmail.com</p>
