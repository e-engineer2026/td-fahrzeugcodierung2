...
export default function FlashInquiryForm() {
  ...
  return (
    <form action="https://formsubmit.co/info@td-fahrzeugcodierung.com" method="POST" encType="multipart/form-data" aria-label="Technische Vorprüfung Steuergeräte-Flash" className="rounded-3xl bg-[#0c2f68] p-4 text-white shadow-xl shadow-blue-950/10 sm:p-6">
